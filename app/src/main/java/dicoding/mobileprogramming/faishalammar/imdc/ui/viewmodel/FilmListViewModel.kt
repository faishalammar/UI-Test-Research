...
class FilmListViewModel(private val moviesSeriesRepository: MoviesSeriesRepository) : ViewModel() {

    fun getMovies(): LiveData<Resource<PagedList<MoviesAndTvShowsEntity>>> = moviesSeriesRepository.getAllMovies()
    fun getSeries(): LiveData<Resource<PagedList<MoviesAndTvShowsEntity>>> = moviesSeriesRepository.getAllTvSeries()
