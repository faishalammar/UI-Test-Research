...
class MoviesSeriesRepository private constructor(
    ...
    companion object {
        @Volatile
        private var instance: MoviesSeriesRepository? = null
        fun getInstance(remoteData: RemoteDataSource, localData: LocalDataSource, appExecutors: AppExecutors): MoviesSeriesRepository =
            instance ?: synchronized(this) {
                instance ?: MoviesSeriesRepository(remoteData, localData, appExecutors).apply { instance = this }
            }
    }
